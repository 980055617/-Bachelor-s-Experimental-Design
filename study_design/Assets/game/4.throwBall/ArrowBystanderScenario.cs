...
public class ArrowBystanderScenario : MonoBehaviour
{
    ...
    IEnumerator WaitAndExecuteAction()
    {
        ...
        ArrowGen ArrowGenA = spawnedPrefab.GetComponent<ArrowGen>();

        ArrowGenA.uiPrefab = uiPrefab;
        ...
        ArrowGen ArrowGenB = spawnedPrefab1.GetComponent<ArrowGen>();

        ArrowGenB.uiPrefab = uiPrefab;
        ...
        ArrowGenA = spawnedPrefab.GetComponent<ArrowGen>();
        ...
        ArrowGenB = spawnedPrefab1.GetComponent<ArrowGen>();
        ...
        ArrowGen ArrowGenC = spawnedPrefab2.GetComponent<ArrowGen>();

        ArrowGenC.uiPrefab = uiPrefab;
